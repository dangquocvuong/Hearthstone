...
Shaman::Shaman(int _hp, int _atk, std::string _name)
	: Unit::Unit(_hp, _atk, UnitType::SHAMAN, UnitStatus::INACTIVE, _name)
{
}

Shaman::Shaman(int _hp, int _atk, UnitType _type, UnitStatus _status, std::string _name)
	: Unit::Unit(_hp, _atk, _type, _status, _name)
{
}

void Shaman::spell(Unit& active_hero, Unit& enemy_hero, std::vector<Unit*>& enemy_onboard_cards, std::vector<Unit*>& alliance_onboard_cards) {
